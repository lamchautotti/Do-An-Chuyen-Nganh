...
namespace DACS.Controllers
{
    public class PaymentController : Controller
    {
        ...
        //Momo
        public ActionResult paymentMomo(string maHoaDon, string tongTien, string diaChi, string soDienThoai)
        {
            ThanhToan thanhToan = new ThanhToan();
            thanhToan.MaHoaDon = int.Parse(maHoaDon);
            thanhToan.TongTien = int.Parse(tongTien);
            ...
            string returnUrl = "https://localhost:44394/Payment/ConfirmPaymentClient";
        ...
        public ActionResult paymentBankCard()
        {
            ...
            int tongTien = int.Parse(dataObject.tongTien + "");
            ...
            if (Request.QueryString.Count > 0)
            {
                ...
                if (checkSignature)
                {
                    if (vnp_ResponseCode == "00")
                    {
                        ...
                        string maHoaDon = dataObject.maHoaDon + "";
                        int tongTien = int.Parse(dataObject.tongTien + "");
                        string diaChi = dataObject.diaChi;
                        string soDienThoai = dataObject.soDienThoai;
